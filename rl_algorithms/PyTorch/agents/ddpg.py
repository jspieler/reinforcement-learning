...
class DDPG:
    def __init__(self, num_actions, num_states, min_action, max_action, lr_actor=0.001,
        ...
        self.noise = OUActionNoise(mean=np.zeros(1), std_deviation=float(noise_stddev) * np.ones(1))
    ...
    def update(self, state_batch, action_batch, reward_batch, next_state_batch, done_batch):
        ...
        y = reward_batch + self.gamma * self.target_critic.forward(next_state_batch, target_actions) * (1 - done_batch)
